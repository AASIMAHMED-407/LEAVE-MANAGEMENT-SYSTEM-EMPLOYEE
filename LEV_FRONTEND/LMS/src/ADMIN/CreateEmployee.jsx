    ...
    <>
        <nav class="navbar bg-body-tertiary">
            <div class="container-fluid">
                <p class="navbar-brand">Creating Employee</p>
                ...
                <div class="card"> 
                    <div class="box"> 
                        <h1>Create Employee</h1> 
                            ...
                            <select class="form-select bg-dark text-white" style={{marginLeft:"20px",width:"380px"}} aria-label="Default select example" onChange={(e)=>{
                                setCreateEmp((prev)=>{
                            ...
                            <select class="my-4 form-select bg-dark text-white" style={{marginLeft:"20px",width:"380px"}} aria-label="Default select example" onChange={(e)=>{
                                setCreateEmp((prev)=>{
                                    prev.role = e.target.value
                                    return prev
                                })
                            }}>
                                <option defaultChecked>select employee role</option>
                                {/* <option value="1">One</option> */}
                                {
                                    roleData.map((item,i)=>(
                                        <option key={i} value={item[1]}>{item[1]}</option>
