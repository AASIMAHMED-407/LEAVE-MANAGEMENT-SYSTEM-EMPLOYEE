                ...
                <div className="card"> 
                    <div className="box"> 
                        <h1>Make Leave</h1> 
                            ...
                            <p className='mx-5' style={{color:"white"}} >START</p>
                            <input type="date" className='bg-dark text-white' onChange={(e)=>{
                                setRequest((prev)=>{
                            ...
                            <p className='mx-5' style={{color:"white"}}>END</p>
                            <input type="date" className='bg-dark text-white' style={{position:"relative",left:"15px"}} onChange={(e)=>{
                                setRequest((prev)=>{
